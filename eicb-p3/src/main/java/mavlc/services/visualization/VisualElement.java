...
public abstract class VisualElement {
	...
	/** A visual node (derived by {@link SimpleNode}, {@link PortNode} and {@link Literal}) **/
	public static abstract class VisualNode extends VisualElement {
		protected VisualNode(String label) { super(label); }
	...
	public static final class SimpleNode extends VisualNode {
		...
		@Override public VisualNodeType type() {
	...
	public static final class PortNode extends VisualNode {
		...
		public PortNode(String label) { this(label, new ArrayList<>()); }
	...
	/** An element that may be part of a {@link PortNode} (derived by {@link Port} and {@link PortGroup}) **/
	...
	/** A group of {@link NodeElement}s, used to group multiple ports within a {@link PortNode} **/
	...
	/** A literal node with a reference to a {@link DeclarationLiteral} (used in decorated ASTs) **/
	public static final class ReferenceLiteral extends Literal {
		public final Supplier<AstNode> resolver;
		public DeclarationLiteral declaration;
		
		public ReferenceLiteral(String label, Supplier<AstNode> resolver) {
			super(label);
	...
	/** Enumeration of different node types, so I can use a switch instead of chained if instanceof checks **/
