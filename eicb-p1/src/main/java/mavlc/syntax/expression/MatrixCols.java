...
/**
 * AST node representation of the primitive ".cols"-expression for matrices.
 * Yields the number of columns in the underlying matrix.
 */
public class MatrixCols extends UnaryExpression {
	
	/**
	 * @param sourceLocation Location of the node within the containing source file.
	 * @param operand The underlying matrix.
	 */
	public MatrixCols(SourceLocation sourceLocation, Expression operand) {
		super(sourceLocation, operand);
	}
	
	@Override
	public <RetTy, ArgTy> RetTy accept(AstNodeVisitor<? extends RetTy, ArgTy> visitor, ArgTy obj) {
		return visitor.visitMatrixCols(this, obj);
	}
}
